...
<div class="stamp">File 02 · Record</div>

# Background

<div class="deck">The résumé is the last chapter. Here's where it actually starts.</div>
...
I was always good at math, but never the memorize-the-formula kind. I loved it the way I loved philosophy — as logic, as a way of thinking about the world. That instinct, to look for the principle underneath the rule instead of the rule itself, is the same one I bring to markets now.

<div class="story-movement rev">
<div class="story-text">

## Finance, found abroad.
...
When I specialized in analytics, I stopped seeing the world as a fixed science with permanent laws. Markets — like most things — run on behavior: ever-changing, context-dependent. So I keep my pattern-recognition sharp, apply what I know with humility, and readapt when the context shifts. That isn't a technique I picked up in finance. It's just how I've always tried to live.

<div class="stack">Baruch College (Pre-MFE) · Hult (MSc Data Analytics) · ESTA France (BSc Business Engineering) · FINRA SIE · Series 66 (in progress) · EN / FR / AR</div>
